...
export const clients = pgTable(
  "clients",
  {
    ...
    deferredSetById: text("deferred_set_by_id").references(() => users.id, { onDelete: "set null", onUpdate: "cascade" }),
    deferredSetAt: timestamp("deferred_set_at", { mode: "date", precision: 3 }),
    createdAt: timestamp("created_at", { mode: "date", precision: 3 }).notNull().defaultNow(),
    updatedAt: timestamp("updated_at", { mode: "date", precision: 3 }).notNull(),
